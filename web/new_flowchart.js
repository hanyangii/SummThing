  ...
  \*******************************************/
    ...
    function(module, exports, __webpack_require__) {
        ...
        inherits(Condition, Symbol), Condition.prototype.render = function() {
            ...
            this.yes_symbol && this.drawLineTo(this.yes_symbol, this.getAttr(""), this.yes_direction), 
            this.no_symbol && this.drawLineTo(this.no_symbol, this.getAttr(""), this.no_direction);
